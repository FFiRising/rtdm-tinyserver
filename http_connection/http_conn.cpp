...
// 网站的根目录
const char* doc_root = "/home/codez/LinuxTest/TinyWebServer2.0/resources";
...
// /home/codez/LinuxTest/TinyWebServer2.0/resources
    ...
    if (m_post_cgi == 1 && (*(p + 1) == '2' || *(p + 1) == '3'))
    {
        ...
        if (*(p + 1) == '3')
        {
            ...
            if (users.find(name) == users.end())
            {
                ...
                //this->initmysql_result(m_connPool);
    ...
    if( strcmp(m_url, "/specdata") == 0){
        return FILE_SPEC;
            ...
            cout << "测试是否进specdata" << endl;
    }
    if( strcmp(m_url, "/jsondata") == 0){
         cout << "测试是否进jsondata" << endl;
        return FILE_JSON;
...
bool http_conn::process_write(HTTP_CODE ret) {
    switch (ret)
    {
        ...
        case FILE_SPEC:
            cout << "test in file spec write" << endl;
            if(m_method == GET){
                add_status_line(200, ok_200_title );
        ...
        case FILE_JSON:{
             cout << "test in file json write" << endl;
            if(m_method == GET){
                add_status_line(200, ok_200_title );
